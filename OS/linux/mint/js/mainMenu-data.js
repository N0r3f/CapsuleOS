...
const MENU_APPS = [
    ...
    { catId: 'bureau',   icon: './media/img/apps/accessories-text-editor.png',     name: 'LibreOffice Writer',          desc: 'Traitement de texte',                      dataLink: null        },
    // Graphisme
    ...
    { catId: 'sonvideo', icon: './media/img/apps/multimedia-video-player.png',     name: 'Lecteur vidéo',               desc: 'Regardez des vidéos',                      dataLink: null        },
