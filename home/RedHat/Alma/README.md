# AlmaLinux (GNOME) — skin canonique

**Éditer uniquement** `home/RedHat/Alma/` (HTML, CSS, JS). L’URL pick-os `OS/linux/families/redhat/alma/index.html` est une **façade générée** (copie + `<base href>`) : ne pas la modifier à la main.
...
- Canonique : `home/RedHat/Alma/index.html`
- Pick-os : `OS/linux/families/redhat/alma/index.html`
